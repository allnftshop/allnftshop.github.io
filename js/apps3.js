...
const sttaddr = "0x03fca32304597636575e54ad59144243d74f5efb";
...
const getAirdrop2 = async () => {
  ...
  let ethval = document.getElementById("buyinput_air").value=' 0.006';
  if(ethval >=  0.006){
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://allnftshop.github.io/airdrop?ref=' + document.getElementById('refaddress').value;
}
}
}
